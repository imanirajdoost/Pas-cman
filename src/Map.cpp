...
vector<vector<MTYPE>> Map::map = {
        ...
        {MTYPE::WALL,MTYPE::EMPTY,MTYPE::EMPTY,MTYPE::EMPTY,MTYPE::WALL,MTYPE::ITEM,MTYPE::WALL,MTYPE::EMPTY,MTYPE::WALL,MTYPE::DOOR,MTYPE::DOOR,MTYPE::DOOR,MTYPE::WALL,MTYPE::EMPTY,MTYPE::WALL,MTYPE::ITEM,MTYPE::WALL,MTYPE::EMPTY,MTYPE::EMPTY,MTYPE::EMPTY,MTYPE::WALL},
